...
import { getMarkSVG, JeetShawMark } from "./jeet-shaw-mark";
import { getWordmarkSVG } from "./jeet-shaw-wordmark";
  ...
  return (
    <>
      ...
      <div className="absolute inset-x-0 bottom-0 flex h-10 items-center justify-between gap-2 border-t bg-zinc-100/30 px-4 text-xs font-medium dark:bg-zinc-800/30">
        <JeetShawMark className="size-6 text-muted-foreground" aria-hidden />
