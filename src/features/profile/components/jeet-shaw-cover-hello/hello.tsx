...
import { JeetShawMark } from "@/components/jeet-shaw-mark";
import { Button } from "@/components/ui/button";
import { SimpleTooltip } from "@/components/ui/tooltip";
import { AppleHelloVietnameseEffect } from "@/registry/apple-hello-effect";

const layers = ["xin-chao", "js-wordmark"] as const;
    ...
    <>
      <AnimatePresence mode="wait" initial={false}>
        ...
        >
          ...
          {layers[currentIndex] === "js-wordmark" && (
            <motion.div
            ...
            >
              <JeetShawMark className="h-12 sm:h-16" />
            </motion.div>
          )}
        </div>
      </AnimatePresence>
